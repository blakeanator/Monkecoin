...
// monkecoin includes.
#include <..\src\script\monkecoinconsensus.h>
...
int main()
{
    std::cout << "monkecoinconsensus version: " << monkecoinconsensus_version() << std::endl;
    ...
    auto op0Result = monkecoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, monkecoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
