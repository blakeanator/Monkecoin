...
Arguments:
    <base_directory> - The base directory of a monkecoin source code repository.
...
Arguments:
    <file> - A source file in the monkecoin repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Monkecoin
