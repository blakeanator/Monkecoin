...
created. To use it for Monkecoin:
...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_monkecoin` executable (see https://github.com/bitcoin/bitcoin/pull/13543),
...
options will be passed to monkecoin's configure. In this case, `--disable-wallet`.
