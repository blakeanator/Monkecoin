...
Since Bitcoin Core 0.17, an RPC interface exists for Partially Signed Monkecoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/monkecoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Monkecoin transactions that are not fully signed
...
the command line in case `monkecoin-cli` is used.
...
Later, when *V* MKE has been received on *Amulti*, and Bob and Carol want to
