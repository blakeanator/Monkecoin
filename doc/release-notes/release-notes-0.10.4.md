Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://monkecoin.org/bin/monkecoin-core-0.10.4/>
...
- #6953 `43c2789` Split monkecoin-tx into its own package
- #6953 `dfe0d4d` Include monkecoin-tx binary on Debian/Ubuntu
