Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://monkecoin.org/bin/monkecoin-core-0.11.0/>
...
defaults to 0.00001. This will cause transactions with fewer MKE/kB fee to be
...
For example, add the following to `monkecoin.conf`:
...
related to the blockchain in the monkecoin system: the raw blocks as received over 
...
For an example script see [monkecoin-submittx](https://github.com/laanwj/monkecoin-submittx).
...
- #5334 `cf87536` libmonkecoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new monkecoin-detached-sigs git repo for OSX signatures
...
- #5729 `9c4a5a5` Allow unit changes for read-only MonkecoinAmountField
- #5753 `0f44672` Add monkecoin logo to about screen
...
- #5809 `46bfbe7` Add monkecoin-cli man page
...
- #5849 `41259ca` contrib/init/monkecoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6116 `30dc3c1` [OSX] rename Monkecoin-Qt.app to Monkecoin-Core.app
- #6168 `b3024f0` contrib/linearize: Support linearization of testnet blocks
- #6098 `7708fcd` Update Windows resource files (and add one for monkecoin-tx)
