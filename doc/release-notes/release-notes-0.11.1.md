Bitcoin Core version 0.11.1 is now available from:
  ...
  <https://monkecoin.org/bin/monkecoin-core-0.11.1/>
...
one was randomly violated by all deployed monkecoin software prior to
...
in March 2014; Monkecoinj has done so for a similar span of time.
Monkecoinjs and electrum have been more recently updated.
...
[1] On the Malleability of Monkecoin Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/monkecoin/paper_9.pdf
...
- #6571 `100ac4e` libmonkecoinconsensus: avoid a crash in multi-threaded environments
