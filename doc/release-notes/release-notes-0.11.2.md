Bitcoin Core version 0.11.2 is now available from:
  ...
  <https://monkecoin.org/bin/monkecoin-core-0.11.2/>
...
- Block versions over the last 50,000 blocks as progress towards BIP65
  consensus enforcement: <http://monkecoin.sipa.be/ver-50k.png>

- Block versions over the last 2,000 blocks showing the days to the
  earliest possible BIP65 consensus-enforced block: <http://monkecoin.sipa.be/ver-2k.png>
...
[BIP65]: https://github.com/monkecoin/bips/blob/master/bip-0065.mediawiki

BIP113 mempool-only locktime enforcement using GetMedianTimePast()
----------------------------------------------------------------

Monkecoin transactions currently may specify a locktime indicating when
...
[BIP113]: https://github.com/monkecoin/bips/blob/master/bip-0113.mediawiki
...
- #6600 `1e672ae` Debian/Ubuntu: Include monkecoin-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split monkecoin-tx into its own package
