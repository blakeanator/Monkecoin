Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://monkecoin.org/bin/monkecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update monkecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow monkecoin-tx to create v2 transactions (btcdrak)
