Monkecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/monkecoin/files/Monkecoin/monkecoin-0.5.4/
...
Fix Monkecoin-Qt notifications under Growl 1.3.
Increase required age of Monkecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMonkecoin properly when installing Monkecoin-Qt over it. (Windows)
