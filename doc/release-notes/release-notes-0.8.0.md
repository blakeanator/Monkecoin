Monkecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/monkecoin/files/Monkecoin/monkecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Monkecoin
...
New/changed settings (command-line or monkecoin.conf file)
--------------------------------------------------------
