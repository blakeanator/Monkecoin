Monkecoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/monkecoin/files/Monkecoin/monkecoin-0.8.4/
...
code, causing the Monkecoin-Qt or monkecoind process to crash.
...
Linux: clicking on monkecoin: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of Monkecoin against Boost versions 1.50-1.52.
