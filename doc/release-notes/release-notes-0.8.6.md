Monkecoin-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/monkecoin/files/Monkecoin/monkecoin-0.8.6/
...
- Fix Monkecoin-Qt startup crash when clicking dock icon on OSX 
