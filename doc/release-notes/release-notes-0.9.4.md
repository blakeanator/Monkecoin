...
this update is incompatible with the Monkecoin system and could lead to consensus
forks.

Bitcoin Core released binaries from https://monkecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~monkecoin/+archive/ubuntu/monkecoin
