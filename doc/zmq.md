...
router", implementing the monkecoin wire protocol and relay, making
...
during the *configure* step of building monkecoind:
...
For instance:
    ...
    $ monkecoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubrawtx=ipc:///tmp/monkecoind.tx.raw \
...
These options can also be provided in monkecoin.conf.
...
From the perspective of monkecoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into monkecoind directly. Furthermore, no information is
...
using. Monkecoind appends an up-counting sequence number to each
