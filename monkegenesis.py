...
def get_args():
  ...
  parser.add_option("-z", "--timestamp", dest="timestamp", default="News18 04/25/2021 Elon Musk Made a 'Typo' and Twitter Wants You to 'Hodl' Cryptocurrency Dictionary to Decode it",
