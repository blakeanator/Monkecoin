 ...
 * for both monkecoind and monkecoin-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/monkecoin/bips/blob/master/bip-0014.mediawiki)
 */
