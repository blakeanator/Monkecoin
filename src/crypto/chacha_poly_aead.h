...
/* A AEAD class for ChaCha20-Poly1305@monkecoin.
 *
 ...
 *
 * The chacha20-poly1305@monkecoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@monkecoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@monkecoin are relatively fast in
