...
const std::string CURRENCY_UNIT = "MKE"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    MKE_KVB,      //!< Use MKE/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from MKE/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::MKE_KVB) const;
