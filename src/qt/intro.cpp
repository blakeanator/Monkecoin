...
bool Intro::showIfNeeded(bool& did_show_intro, bool& prune)
{
     ...
     * override -datadir in the monkecoin.conf file in the default data directory
     * (to be consistent with monkecoind behavior)
     */
    if(dataDir != GUIUtil::getDefaultDataDirectory()) {
...
void Intro::UpdatePruneLabels(bool prune_checked)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the Monkecoin block chain.").arg(PACKAGE_NAME) + " " +
