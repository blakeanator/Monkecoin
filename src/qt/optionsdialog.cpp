    ...
    mapper(nullptr)
{
    ...
    ui->monkecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->monkecoinAtStartup);
    ...
    ui->monkecoinAtStartup->setToolTip(ui->monkecoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->monkecoinAtStartup->setText(ui->monkecoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openMonkecoinConfButton->setToolTip(ui->openMonkecoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MonkecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->monkecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMonkecoinConfButton_clicked()
{
