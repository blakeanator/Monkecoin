    ...
    platformStyle(_platformStyle)
{
    ...
    // normal monkecoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying monkecoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &MonkecoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
