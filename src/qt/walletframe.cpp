...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, MonkecoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &MonkecoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &MonkecoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &MonkecoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &MonkecoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &MonkecoinGUI::updateWalletStatus);
    connect(gui, &MonkecoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
