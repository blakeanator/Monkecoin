 ...
 *  A CTxDestination is the internal data type encoded in a monkecoin address
 */
...
/**
 * Generate a Monkecoin scriptPubKey for the given CTxDestination. Returns a P2PKH
