...
{
    BOOST_CHECK(TestSplitHost("www.monkecoincore.org", "www.monkecoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.monkecoincore.org]", "www.monkecoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.monkecoincore.org:80", "www.monkecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.monkecoincore.org]:80", "www.monkecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:1165", "127.0.0.1", 1165));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:1165", "127.0.0.1", 1165));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:1165", "::ffff:127.0.0.1", 1165));
    BOOST_CHECK(TestSplitHost("[::]:1165", "::", 1165));
    BOOST_CHECK(TestSplitHost("::1165", "::1165", -1));
    BOOST_CHECK(TestSplitHost(":1165", "", 1165));
    BOOST_CHECK(TestSplitHost("[]:1165", "", 1165));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:1165", "127.0.0.1:1165"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:1165", "[::]:1165"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
