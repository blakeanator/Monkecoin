...
static const uint16_t VERSIONBITS_LAST_OLD_BLOCK_VERSION = 4;
/** What bits to set in version for versionbits blocks */
static const uint16_t VERSIONBITS_TOP_BITS = 0x2000UL;
/** What bitmask determines whether versionbits is in use */
static const uint16_t VERSIONBITS_TOP_MASK = 0xE000UL;
/** Total bits available for versionbits */
static const uint16_t VERSIONBITS_NUM_BITS = 13;
