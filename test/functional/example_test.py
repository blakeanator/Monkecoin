...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MonkecoinTestFramework
    pass


class ExampleTest(MonkecoinTestFramework):
    # Each functional test is a subclass of the MonkecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        MonkecoinTestFramework class so other tests can use it."""
