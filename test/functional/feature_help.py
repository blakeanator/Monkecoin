...
"""Verify that starting monkecoin with -h works as expected."""

from test_framework.test_framework import MonkecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(MonkecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start monkecoin with -h for help text")
        ...
        self.log.info("Start monkecoin with -version for version information")
        ...
        self.log.info("Start monkecoind with -fakearg to make sure it does not start")
