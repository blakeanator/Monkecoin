...
By default, monkecoind will dump mempool on shutdown and
...
class MempoolPersistTest(MonkecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent monkecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
