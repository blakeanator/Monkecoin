...
class TestShell:
    """Wrapper Class for MonkecoinTestFramework.

    The TestShell class extends the MonkecoinTestFramework
    ...
    class __TestShell(MonkecoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MonkecoinTestFramework child class.
            self.num_nodes = 1
